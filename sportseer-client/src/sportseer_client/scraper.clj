...
(def nba-match-urls ^:const [{:name "NBA Season '13-'14"
                              :url "https://www.scoreboard.com/uk/nba-2013-2014/results/"}
                             {:name "NBA Season '14-'15"
                              :url "https://www.scoreboard.com/uk/nba-2014-2015/results/"}
                             {:name "NBA Season '15-'16"
                              :url "https://www.scoreboard.com/uk/nba-2015-2016/results/"}
                             {:name "NBA Season '16-'17"
                              :url "https://www.scoreboard.com/uk/nba-2016-2017/results/"}
                             {:name "NBA Season '17-'18"
                              :url "https://www.scoreboard.com/uk/nba-2017-2018/results/"}])
...
(defn expand-player-stats-row [stats-row]
  (let [fgs (clojure.string/split (:fg stats-row) #"-") ;need to change this to include "_" as well
